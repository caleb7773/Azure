...
az tag create --resource-id $grouppy --tags UserAzure=${username} Persistent=unknown UseCase=${server_name} Scripted=TechAzurePanda VPNPort=${port} VPNSubnet=${server_ip} 
echo -e "${NC}"
